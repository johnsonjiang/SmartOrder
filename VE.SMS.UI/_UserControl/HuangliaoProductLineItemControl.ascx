<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HuangliaoProductLineItemControl.ascx.cs"
    Inherits="VE.SMS.UI._UserControl.HuangliaoProductLineItemControl" %>
