...
{
	public partial class JiaProductLineItemControl : BaseUserControl
	{
        ...
        private List<Proce_GetProductByJia_Result> GetProductList()
        {
            ProductDAL dal = new ProductDAL();
            var products = dal.GetProductSummaryByJia(Code,
                                            ProductName,
                                            HuangCode,
                                            JiaCode,
                                            PianCode,
