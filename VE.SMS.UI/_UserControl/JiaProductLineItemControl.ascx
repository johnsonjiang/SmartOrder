<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="JiaProductLineItemControl.ascx.cs"
    Inherits="VE.SMS.UI._UserControl.JiaProductLineItemControl" %>
        ...
        <table class="listtable">
            <tbody>
                <tr class="gridheader">
                    ...
                    <td>
                        <asp:LinkButton ID="btnHuangliaoCode" runat="server" Text="荒料号" OnClick="Sort_Click"
                            CommandName="HuangliaoCode"></asp:LinkButton>
                    </td>
                    <td>
                        <asp:LinkButton ID="btnJiaCode" runat="server" Text="架号" OnClick="Sort_Click" CommandName="JiaCode"></asp:LinkButton>
                    </td>
                    <td>
                ...
                <asp:Repeater ID="rpProductList" runat="server" OnItemDataBound="rpProductList_ItemDataBound">
                    <ItemTemplate>
                        <tr class="gridrow">
                            <td>
                                <%#Eval("Product_Name")%>
