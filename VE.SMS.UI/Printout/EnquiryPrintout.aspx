<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EnquiryPrintout.aspx.cs"
    Inherits="VE.SMS.UI.Printout.EnquiryPrintout" %>
                    ...
                    <tr>
                        <td width="75%">
                            <%
                                ...
                                var footers = dal.GetFooterBySource(EnqNo, VE.SMS.Common.SysConst.SourceTypeEnquiry);
