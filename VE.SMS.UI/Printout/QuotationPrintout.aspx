<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuotationPrintout.aspx.cs"
    Inherits="VE.SMS.UI.Printout.QuotationPrintout" %>
                    ...
                    <tr>
                        <td width="75%">
                            <%
                                ...
                                var footers = dal.GetFooterBySource(QuoNo, VE.SMS.Common.SysConst.SourceTypeQuote);
